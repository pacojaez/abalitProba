<main class="mx-2 my-2 bg-pink-200">
    <div class="container flex flex-col px-6 py-12 mx-auto lg:h-full lg:py-16 lg:flex-row lg:items-start lg:space-x-6">
      <div class="flex flex-col items-center justify-center w-full lg:w-1/2">
          <img class="object-cover w-full h-full max-w-2xl rounded-md" src="https://images.unsplash.com/photo-1493863641943-9b68992a8d07?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=739&q=80"
          alt="glasses photo">
          ...
          <div class="flex flex-col items-center justify-center mt-6 md:flex-row">
              ...
              <div class="flex flex-col justify-center mx-0 my-2 transition-all duration-1000 ease-in-out md:mx-4">
                  <img class="object-cover w-full h-full max-w-2xl rounded-md" src="https://images.unsplash.com/photo-1493863641943-9b68992a8d07?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=739&q=80"
          alt="glasses photo">
              </div>
              <div class="flex flex-col justify-center my-2 ml-0 transition-all duration-1000 ease-in-out md:ml-2">
                  <img class="object-cover w-full h-full max-w-2xl rounded-md" src="https://images.unsplash.com/photo-1493863641943-9b68992a8d07?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=739&q=80"
                  alt="glasses photo">
              </div>
          </div>
          <div class="flex flex-col items-start justify-start mt-6 md:flex-row">
              <div class="flex flex-col justify-start my-6 mr-0 transition-all duration-1000 ease-in-out md:mr-2">
                  <ol>
                    ...
                    <li class="text-xs font-extrabold text-purple-700 list-disc">VINTAGE CLOTHING IS USED CLOTHING</li>
                    <li class="text-xs font-extrabold text-purple-700 list-disc">WE DON´T ACCEPT RETURNS OR EXCHANGES</li>
                    <li class="text-xs font-extrabold text-purple-700 list-disc">ALL CLOTHES ARE SANITIZED AND IRONED (EXCEPT WHOLESALE CLOTHES)</li>
                    <li class="text-xs font-extrabold text-purple-700 list-disc">IF YOU HAVE ANY QUESTION PLEASE CONTACT US BEFORE BUYING AND WE´LL HELP YOU</li>
                  </ol>
              </div>
      ...
      <div class="w-full lg:w-1/2">
            <div class="lg:max-w-lg">
                <h1 class="mt-0 text-4xl font-bold tracking-wide text-purple-800 dark:text-white lg:text-4xl">CHAMPION OUTFIT</h1>
                <hr class="white">
                ...
                <div class="flex items-center justify-center w-full mx-4 p-7">
                    <button type="button" onclick="modalClose('mymodalcentered')" class="px-4 py-2 mx-4 font-bold text-gray-200 bg-pink-400 border border-pink-500 rounded W-1/2 hover:bg-pink-500 hover:text-white hover:border-transparent hover:shadow-xl">
                      ADD TO WISHLIST
                  </button>
                  <button type="button" class="px-4 py-2 mx-4 font-bold text-gray-200 bg-purple-400 border border-purple-900 rounded W-1/2 hover:bg-purple-700 hover:text-white hover:border-transparent hover:shadow-xl">
                        ADD TO CHART
                    </button>
...
<div class="flex flex-col items-center justify-center mx-2 my-2 bg-pink-200 md:flex-row">
