<div>
    <div class="flex flex-wrap mt-8 -mx-1 sm:-mx-3 lg:-mx-2 xl:-mx-2">
        <div class="w-full p-2 mx-4 font-sans rounded bg-grey-light">
            <ol class="flex list-reset text-grey-dark">
                ...
                <li><a href="{{ route ('productos_category', ['id' => $product->category->id ]) }}"
                        class="font-bold">{{ $product->category->name }}</a></li>
                <li><span class="mx-2">></span></li>
                {{-- <li>{{ $product->name }}</li> --}}
            </ol>
        </div>
    ...
    <div class="w-full px-1 mx-4 my-1 sm:my-3 sm:px-3 sm:w-full lg:my-2 lg:px-2 xl:my-2 xl:px-2">
        <div class="flex flex-row flex-wrap sm:-mx-3 xl:-mx-2">
            ...
            <div class="px-8 rounded-lg" style="background: url({{ asset('storage/images/'.$product->image) }});
