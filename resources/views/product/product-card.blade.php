<main class="mx-2 my-1 bg-pink-200">
    <div
        ...
        <div class="flex flex-col items-center justify-center w-full lg:w-1/2">
            ...
            <div class="flex flex-row items-center justify-center mt-6 md:flex-row">
                ...
                <div
                    class="flex flex-col justify-center mx-0 my-2 transition-all duration-1000 ease-in-out md:mx-4">
                    <img class="object-cover w-full h-full max-w-2xl rounded-md md-h-full"
                        src="https://images.unsplash.com/photo-1493863641943-9b68992a8d07?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=739&q=80"
                        alt="glasses photo">
                </div>
                <div
                    class="flex flex-col justify-center my-2 ml-0 transition-all duration-1000 ease-in-out md:ml-2">
                    <img class="object-cover w-full h-full max-w-2xl rounded-md md-h-full"
                        src="https://images.unsplash.com/photo-1493863641943-9b68992a8d07?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=739&q=80"
                        alt="glasses photo">
                </div>
